...
Hazel::OpenGlTexture2DArray::OpenGlTexture2DArray(const std::vector<std::string>& paths, int numMaterials, int channels, bool bUse16BitTexture)
...
void Hazel::OpenGlTexture2DArray::Create16BitTextures(const std::vector<std::string>& paths, int numMaterials)
{
...
void Hazel::OpenGlTexture2DArray::Create8BitsTextures(const std::vector<std::string>& paths, int numMaterials)
{
	GLenum InternalFormat = 0, Format = 0;
