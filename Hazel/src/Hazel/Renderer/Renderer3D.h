...
namespace Hazel {
	...
	public:
		...
		static void DrawFoliageInstanced(LoadMesh& mesh, glm::mat4& transform,size_t instance_count, const glm::vec4& color = { 0,0,0,1 }, const float& material_Roughness = 1.0f, const float& material_metallic = 0.0f);//take the mesh class reference
