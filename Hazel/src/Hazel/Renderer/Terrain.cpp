...
namespace Hazel
{
	...
	{
		grass = std::make_shared<Foliage>(Scene::Grass, std::ceil(512*512/2.0),512,512,200);
		...
		Fern = std::make_shared<Foliage>(Scene::Fern, std::ceil(512 * 512 / 8.0), 512, 512, 100);
